...
define('INTERSOCCER_REFERRAL_VERSION', '1.9.16');
    ...
    */
    public function enqueue_frontend_assets() {
        ...
        if (function_exists('is_checkout') && is_checkout() && is_user_logged_in() && !get_option('intersoccer_passive_mode', false)) {
            ...
            $checkout_asset_ver = INTERSOCCER_REFERRAL_VERSION . '.' . (string) filemtime(INTERSOCCER_REFERRAL_PATH . 'assets/css/checkout.css');
