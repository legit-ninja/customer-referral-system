...
// Note: This file previously emitted a raw <script> block for a one-off demo.
// That output has been removed to keep this file valid PHP and to avoid mixing PHP with inline JS.