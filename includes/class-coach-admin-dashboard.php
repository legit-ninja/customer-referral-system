...
class InterSoccer_Coach_Admin_Dashboard {
    ...
    private function render_enhanced_dashboard($data) {
        ...
        <!-- Styles/scripts moved to enqueued assets -->
        <?php
    }
    ...
    public function render_coach_profile() {
        ...
        <!-- Styles moved to enqueued assets -->
        <?php
    }
    ...
    public function render_coach_resources() {
        ...
        <!-- Script moved to enqueued assets -->
        <?php
    }
    ...
    public function hide_admin_notices_for_coaches() {
        if (current_user_can('coach') && !current_user_can('manage_options')) {
            // Styles moved to assets/css/coach-admin-dashboard.css
        }
    }
    ...
    public function enqueue_coach_admin_styles($hook) {
        if (current_user_can('coach') && !current_user_can('manage_options')) {
            ...
            wp_enqueue_style('coach-admin-dashboard-styles', INTERSOCCER_REFERRAL_URL . 'assets/css/coach-admin-dashboard.css', ['coach-admin-styles'], INTERSOCCER_REFERRAL_VERSION);
            wp_enqueue_script('coach-admin-js', INTERSOCCER_REFERRAL_URL . 'assets/js/coach-admin.js', [], INTERSOCCER_REFERRAL_VERSION, true);
